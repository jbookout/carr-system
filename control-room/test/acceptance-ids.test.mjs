...
const assertions = {
  ...
  umbrella_program_alignment: () => {
    ...
    assert.match(councilLaunch.single_session_council_orchestration.role_boundary, /chair session also supplies.*Claude frontier-seat reviewer.*no fourth vote.*approval authority/i);
