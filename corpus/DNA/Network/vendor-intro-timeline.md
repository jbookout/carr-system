...
3. **Match on top of that:** honor `introduction-rules.md` — vertical fit and state split (e.g., BofA vet lending Dahl=AL / Navarro=FL), and skip anyone the client already has (from the intake "Key players").
