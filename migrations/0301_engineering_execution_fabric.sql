-- 0301_engineering_execution_fabric.sql
--
...
begin
  if to_regclass('ops.engineering_slice_plan') is null
    ...
    raise exception '0301 FAILED: typed engineering execution tables are missing';
  end if;
  if has_table_privilege('carr_jobs','ops.engineering_slice_receipt','update')
    ...
    raise exception '0301 FAILED: carr_jobs can rewrite typed receipts';
  end if;
end $$;
