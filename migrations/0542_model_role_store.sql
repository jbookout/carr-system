...
--
-- Numbered migration of the reviewed role-store candidate from PR #945.
-- This installs the role schema only; it creates no role revision or occupant.
-- The paired SCAC successor and hosted database checks must be green before
-- release, and exact production readback is required before use.
--
-- IT INSTALLS FRESH, OR IT REFUSES. THERE IS NO IN-PLACE REPAIR PROGRAM HERE.
...
-- than repaired. A database that already carries these objects requires a
-- separate forward migration with an explicit compatibility and row decision;
-- this fresh-install migration refuses that case.
--
