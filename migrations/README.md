...
`0264_authenticated_application_session.sql` is the authenticated application-session
...
`0264` creates `carr_session_minter`, and that role is the whole of its separation
