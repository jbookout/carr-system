...
--      2026 (12 suites)" passes), local_phone (555-0100, 555 - 0100; and
--      any 3-digit and 4-digit group split by up to three
--      non-alphanumerics, spaces included: "Contact 555 0100", "555/0100",
--      unless an area or count unit directly follows ("Office 555 1200
--      SF") or a place word comes before ("Suites 200 1500");
...
--      letters ("two five one five five five zero one zero zero", "251-555-O1OO") and "Suite
--      555-1234".
...
language sql immutable parallel safe as $$
  values
    ...
    (4, 'local_phone', 'nosuite', '(^|[^0-9])[2-9][0-9]{2} ?[.\u2013\u2014-] ?[0-9]{4}([^0-9]|$)|(^|[^0-9$])(?<!(^|[^A-Za-z])(suites?|ste|bldgs?|building|units?|floors?|lots?|hwy|exit|route)([^A-Za-z0-9]{1,3}[0-9]{1,4},)*[^A-Za-z0-9]{1,3})[0-9]{3}[^A-Za-z0-9]{0,3}[0-9]{4}(?![0-9])(?![ -]?(([pP][aA][rR][kK][iI][nN][gG]|[cC][oO][vV][eE][rR][eE][dD]|[sS][uU][rR][fF][aA][cC][eE]|[rR][eE][sS][eE][rR][vV][eE][dD]) )?([sS][fF]|[rR][sS][fF]|[uU][sS][fF]|[sS][qQ]|[sS][qQ][fF][tT]|[sS][qQ][uU][aA][rR][eE]|[fF][tT]|[fF][eE][eE][tT]|[fF][oO][oO][tT]|[sS][pP][aA][cC][eE][sS]?|[sS][tT][aA][lL][lL][sS]?|[aA][cC][rR][eE][sS]?|[aA][cC]|[sS][eE][aA][tT][sS]?)([^A-Za-z]|$))'),
