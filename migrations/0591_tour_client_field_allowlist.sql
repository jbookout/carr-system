...
--      has its own plural ("Pines" is not "pin" + "es"). A number followed by
--      a unit is a measure ("Garage 250 spaces", "Door-to-door 250 ft"); a
...
returns text language sql immutable parallel safe as $$ select '(^|[^0-9])([0-9]{3})(?!, )[^A-WYZa-wyz0-9]{0,6}([0-9]{3})(?!, )[^A-WYZa-wyz0-9]{0,6}([0-9]{4})(?![0-9])(?![^A-Za-z0-9]{0,3}([sS][fF]|[rR][sS][fF]|[uU][sS][fF]|[sS][qQ]|[sS][qQ][fF][tT]|[sS][qQ][uU][aA][rR][eE]|[fF][tT]|[fF][eE][eE][tT]|[fF][oO][oO][tT]|[sS][pP][aA][cC][eE][sS]?|[sS][tT][aA][lL][lL][sS]?|[aA][cC][rR][eE][sS]?|[aA][cC]|[uU][nN][iI][tT][sS]?|[sS][eE][aA][tT][sS]?|[dD][oO][oO][rR][sS]?|[dD][oO][cC][kK][sS]?|[pP][sS][fF]|[mM][oO]|[yY][rR])([^A-Za-z]|$))'::text $$;
...
language sql immutable parallel safe as $$
  values
    ...
    (6, 'access_code', 'raw', '(^|[^A-Za-z])(gate|door|key|entry|garage|alarm|keypad|access|lock)[ -]?(codes?|combos?|combination|pins?|passwords?)([^A-Za-z]|$)|(^|[^A-Za-z])(gates?|pins?|combos?|combinations?|keys?|entry|entries|access(es)?|call ?box(es)?|entrances?|passwords?|passcodes?|security|securities|lock ?box(es)?|box(es)?|key ?pads?|key-pads?|key ?safes?|padlocks?|fobs?|buzzers?|intercoms?|sentri ?locks?|alarms?|supras?|garages?|doors?|locks?)([^A-Za-z0-9]{1,6}(number|(?!(suites?|ste|units?|bldgs?|floors?|rooms?|levels?|lots?|bays?|phase|pads?|hwy|exit|route|rt|road|i|us|sr|cr|st|ave|blvd|dr|rd|ln|way|pkwy|miles?)[^A-Za-z0-9])[A-Za-z]{1,5})){0,2}[^A-Za-z0-9]{0,6}(?!(19|20)[0-9]{2}[^A-Za-z0-9]{1,3}(upgrad|renovat|remodel|retrofit|replac|install|updat|built|build|construct|lease|deliver|complet|edition|standard|complian|expan|refresh|addition|rebuil|conver|inspect|certif|vintage|budget))(?!24/7([^0-9]|$))(?![0-9]{1,2}/[0-9]{1,2}/[0-9]{2,4}([^0-9]|$))(?![0-9]([^A-Za-z0-9,]{0,3}[0-9])*[^A-Za-z0-9]{0,3}([sS][fF]|[rR][sS][fF]|[uU][sS][fF]|[sS][qQ]|[sS][qQ][fF][tT]|[sS][qQ][uU][aA][rR][eE]|[fF][tT]|[fF][eE][eE][tT]|[fF][oO][oO][tT]|[sS][pP][aA][cC][eE][sS]?|[sS][tT][aA][lL][lL][sS]?|[aA][cC][rR][eE][sS]?|[aA][cC]|[uU][nN][iI][tT][sS]?|[sS][eE][aA][tT][sS]?|[dD][oO][oO][rR][sS]?|[dD][oO][cC][kK][sS]?|[pP][sS][fF]|[mM][oO]|[yY][rR])([^A-Za-z]|$))[0-9]([^A-Za-z0-9,]{0,3}[0-9]){2,}|(^|[^A-Za-z])(?<!zip )(?<!zip-)(?<!area )(?<!area-)(?<!building )(?<!fire )(?<!electrical )(?<!plumbing )(?<!mechanical )(?<!energy )(?<!zoning )(?<!safety )(?<!health )codes?([^A-Za-z0-9]{1,6}(number|(?!(suites?|ste|units?|bldgs?|floors?|rooms?|levels?|lots?|bays?|phase|pads?|hwy|exit|route|rt|road|i|us|sr|cr|st|ave|blvd|dr|rd|ln|way|pkwy|miles?)[^A-Za-z0-9])[A-Za-z]{1,5})){0,2}[^A-Za-z0-9]{0,6}(?!(19|20)[0-9]{2}[^A-Za-z0-9]{1,3}(upgrad|renovat|remodel|retrofit|replac|install|updat|built|build|construct|lease|deliver|complet|edition|standard|complian|expan|refresh|addition|rebuil|conver|inspect|certif|vintage|budget))(?!24/7([^0-9]|$))(?![0-9]{1,2}/[0-9]{1,2}/[0-9]{2,4}([^0-9]|$))(?![0-9]([^A-Za-z0-9,]{0,3}[0-9])*[^A-Za-z0-9]{0,3}([sS][fF]|[rR][sS][fF]|[uU][sS][fF]|[sS][qQ]|[sS][qQ][fF][tT]|[sS][qQ][uU][aA][rR][eE]|[fF][tT]|[fF][eE][eE][tT]|[fF][oO][oO][tT]|[sS][pP][aA][cC][eE][sS]?|[sS][tT][aA][lL][lL][sS]?|[aA][cC][rR][eE][sS]?|[aA][cC]|[uU][nN][iI][tT][sS]?|[sS][eE][aA][tT][sS]?|[dD][oO][oO][rR][sS]?|[dD][oO][cC][kK][sS]?|[pP][sS][fF]|[mM][oO]|[yY][rR])([^A-Za-z]|$))[0-9]([^A-Za-z0-9,]{0,3}[0-9]){2,}|(^|[^A-Za-z])(building|fire|electrical|plumbing|mechanical|energy|zoning|safety|health) codes?([^A-Za-z0-9]{1,6}(number|(?!(suites?|ste|units?|bldgs?|floors?|rooms?|levels?|lots?|bays?|phase|pads?|hwy|exit|route|rt|road|i|us|sr|cr|st|ave|blvd|dr|rd|ln|way|pkwy|miles?)[^A-Za-z0-9])[A-Za-z]{1,5})){0,2}[^A-Za-z0-9]{0,6}(?!(19|20)[0-9]{2}([^0-9]|$))(?!(19|20)[0-9]{2}[^A-Za-z0-9]{1,3}(upgrad|renovat|remodel|retrofit|replac|install|updat|built|build|construct|lease|deliver|complet|edition|standard|complian|expan|refresh|addition|rebuil|conver|inspect|certif|vintage|budget))(?!24/7([^0-9]|$))(?![0-9]{1,2}/[0-9]{1,2}/[0-9]{2,4}([^0-9]|$))(?![0-9]([^A-Za-z0-9,]{0,3}[0-9])*[^A-Za-z0-9]{0,3}([sS][fF]|[rR][sS][fF]|[uU][sS][fF]|[sS][qQ]|[sS][qQ][fF][tT]|[sS][qQ][uU][aA][rR][eE]|[fF][tT]|[fF][eE][eE][tT]|[fF][oO][oO][tT]|[sS][pP][aA][cC][eE][sS]?|[sS][tT][aA][lL][lL][sS]?|[aA][cC][rR][eE][sS]?|[aA][cC]|[uU][nN][iI][tT][sS]?|[sS][eE][aA][tT][sS]?|[dD][oO][oO][rR][sS]?|[dD][oO][cC][kK][sS]?|[pP][sS][fF]|[mM][oO]|[yY][rR])([^A-Za-z]|$))[0-9]([^A-Za-z0-9,]{0,3}[0-9]){2,}|(^|[^A-Za-z])zip[ -]?codes?([^A-Za-z0-9]{1,6}(number|(?!(suites?|ste|units?|bldgs?|floors?|rooms?|levels?|lots?|bays?|phase|pads?|hwy|exit|route|rt|road|i|us|sr|cr|st|ave|blvd|dr|rd|ln|way|pkwy|miles?)[^A-Za-z0-9])[A-Za-z]{1,5})){0,2}[^A-Za-z0-9]{0,6}(?![0-9]{5}(-[0-9]{4})?([^0-9]|$))[0-9]([^A-Za-z0-9,]{0,3}[0-9]){2,}|(^|[^A-Za-z])area[ -]?codes?([^A-Za-z0-9]{1,6}(number|(?!(suites?|ste|units?|bldgs?|floors?|rooms?|levels?|lots?|bays?|phase|pads?|hwy|exit|route|rt|road|i|us|sr|cr|st|ave|blvd|dr|rd|ln|way|pkwy|miles?)[^A-Za-z0-9])[A-Za-z]{1,5})){0,2}[^A-Za-z0-9]{0,6}([0-9]{4}|[0-9]{1,3}[^A-Za-z0-9][0-9])'),
