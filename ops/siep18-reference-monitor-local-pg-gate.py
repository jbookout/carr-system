...
# 0598 installs v71 as the live frontier and demotes v70 to sealed history.
# Both are pinned: an unreviewed frontier, or a v40 row the successor rewrote
# instead of sealing, has to fail this gate closed. v71 (V5-A05, PR #1236) is
# a plain adjacent successor to v70 (#1243, merged to main at 1cc94b84 --
# main's newest as of this seal; orchestrator's 2026-09-24
# no-pre-assigned-versions ruling).
#
...
LIVE_REGISTRY_MIGRATION = (
    "migrations/0598_delivery_cadence_a05_scac_successor.sql"
)
