...
# 0559 installs v51 as the live frontier and demotes v50 to sealed history.
...
LIVE_REGISTRY_VERSION = "scac-mutation-registry.v51"
LIVE_REGISTRY_ORDINAL = 51
SEALED_PREDECESSOR_VERSION = "scac-mutation-registry.v50"
SEALED_PREDECESSOR_ORDINAL = LIVE_REGISTRY_ORDINAL - 1
SEALED_PREDECESSOR_DIGEST = (
    "sha256:3fc3a027b2e713c563ec2f0fcf2d50c4b84916f36dd67c1c0e86325a16f18a1e"
)
SEALED_PREDECESSOR_ENTRY_COUNTS = (2013, 891)
SEALED_PREDECESSOR_MIGRATION = (
    "migrations/0558_machine_role_headroom_scac_successor.sql"
)
LIVE_REGISTRY_MIGRATION = (
    "migrations/0559_schema_snapshot_dedup_scac_successor.sql"
)
