...
# 0560 installs v52 as the live frontier and demotes v51 to sealed history.
...
LIVE_REGISTRY_VERSION = "scac-mutation-registry.v52"
LIVE_REGISTRY_ORDINAL = 52
SEALED_PREDECESSOR_VERSION = "scac-mutation-registry.v51"
SEALED_PREDECESSOR_ORDINAL = LIVE_REGISTRY_ORDINAL - 1
SEALED_PREDECESSOR_DIGEST = (
    "sha256:f41878345bfd9a4c6c55cb96362a22a401d8410747521df662d9e437f10dc51c"
)
SEALED_PREDECESSOR_ENTRY_COUNTS = (2017, 891)
SEALED_PREDECESSOR_MIGRATION = (
    "migrations/0559_schema_snapshot_dedup_scac_successor.sql"
)
LIVE_REGISTRY_MIGRATION = (
    "migrations/0560_jev_handoff_scac_successor.sql"
)
