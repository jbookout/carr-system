...
the decision rules and touches no database. Migration 0286's own proof block
...
not a hole: both mutations are caught by migration 0286's proof block (cases 5
...
def main():
    ...
    with psycopg.connect(owner, autocommit=True) as conn, conn.cursor() as cur:
        ...
        if cur.fetchone()[0] is None:
            refuse("migration 0286 is not applied to this cluster")
