...
(add --port N if the default is taken by another session)."
  ...
  for proof in cost-ledger-projection.v5 doc-conversation notifications session-identity dispatch-spine meeting-mode delivery-cadence-a05-tools amend-closed-loop-postgres independent-review-cycle-postgres; do
