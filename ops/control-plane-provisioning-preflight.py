...
def validate(config: dict[str, Any]) -> list[str]:
    ...
    # The ":-" default is required: nightly.sh runs under `set -u`, and the bare
    # form aborted the whole chain whenever the key was absent from db.env. The
    # scope this line guards is unchanged — the mirror still receives the backup
    # credential or nothing, and an empty value cannot smuggle an owner URL.
