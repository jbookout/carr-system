...
POST_0481_ACTIVATION_DIGEST = "784e05273341f5f7c16f96d1f0fb1516d8c605cb3287dec32aa37a1211dd0cb8"
...
def main() -> int:
    ...
    with psycopg.connect(dsn, autocommit=True) as conn, conn.cursor() as cur:
        ...
        # 6d->eeb, and 0481 eeb->784 sequence reached its real terminal state.
        cur.execute(
            """select count(*),
