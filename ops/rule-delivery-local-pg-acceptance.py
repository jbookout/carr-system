...
MIGRATION_0363_ACTIVATION_DIGEST = "f7bf5726d329dd240434e51f7401fac9a977a3fb710636738f379f60f565f904"
        ...
        with psycopg.connect(dsn) as receipt_conn, receipt_conn.cursor() as receipt_cur:
            ...
            receipt_cur.execute("""select count(*),
                          ...
                          from ops.rule_delivery_activation_target""",
                                (MIGRATION_0363_ACTIVATION_DIGEST, RETIRED_ACTIVATION_ID))
