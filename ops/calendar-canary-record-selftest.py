...
child=(ROOT/'tools/calendar-canary-result.py').read_text(); runner=(ROOT/'tools/control-plane.py').read_text(); capture=(ROOT/'bin/calendar-eventkit-capture.sh').read_text(); sql=(ROOT/'migrations/0200_calendar_canary_record_layer.sql').read_text()
