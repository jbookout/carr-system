...
MIGRATIONS = [
    ...
    "0249_calendar_prebrief_joe_runtime", "0250_renewal_signed_source_ingress",
]
STEPS = [
...
def main() -> int:
    ...
    bad = copy.deepcopy(contract); bad["candidate"]["migrations"] = list(MIGRATIONS); bad["candidate"]["migrations"][-1] = "0230_renewal_decision_delivery_replayed"
