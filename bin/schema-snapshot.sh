...
if [ "$SCAC_REGISTRY_APPLIED" = t ]; then
  if [ "$V5_SCHEDULED_JOB_ADMISSION_REGISTRY_APPLIED" = t ]; then
    SCAC_CURRENT_NUMBER=25
    SCAC_VERSION_COUNT=25
    SCAC_TOTAL_ENTRY_COUNT=37054
    SCAC_CURRENT_ENTRY_COUNT=1608
    SCAC_CURRENT_SOURCE_COUNT=839
