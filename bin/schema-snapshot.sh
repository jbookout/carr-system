...
# v57 is one entry in ops/config/scac-registry-successors.v1.json; the
...
SCAC_DELTA_APPLIED=""
SCAC_DELTA_PREV_APPLIED="$TOUR_PROPERTY_REGISTRATION_REGISTRY_APPLIED"
SCAC_DELTA_PREV_LABEL="tour property registration v57"
