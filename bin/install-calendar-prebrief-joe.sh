...
sed -e "s|{{REPO}}|$REPO|g" -e "s|{{HOME}}|$HOME|g" "$REPO/ops/launchd/com.carr.calendar-prebrief-joe.plist" > "$HOME/Library/LaunchAgents/com.carr.calendar-prebrief-joe.plist"
