#!/usr/bin/env python3
"""
rerender-observed-comments.py -- WR-000046 comparison seat (slice-compare).

Applies the diff_comments() fix documented in gen-frontier-manifest.py
...
Usage:
    python3 rerender-observed-comments.py
