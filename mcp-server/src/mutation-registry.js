...
// v78 is the runtime selector after amend-closed-loop (migration 0702,
// loop_amendment: an append-only door to correct a CLOSED loop's outcome
// without rewriting history, filed for defect a2c04ffa-92d0-4428-b175-
// 32fa3cfb0802). Its sealed catalog admits the one new write verb and
// preserves earlier versions as history. PROVISIONAL: v78 is the next free
// version against origin/main at authoring time, but the done-record fix,
// correspondence and CRE-lifecycle PRs are already queued for v78/v79/v80 --
// expect this to be re-chained to the actual next free version (v81, if all
// three land first) at push time. It chains over v77 (migration 0627).
//
