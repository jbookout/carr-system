...
test("the ACTIVE runtime registry is v63, and a stale v19 import fails admission", async () => {
  ...
  // one amend-closed-loop verb (defect a2c04ffa, loop c7265238); v82 admits
  // the V5-A02 coverage read and authority-only fallback receipt writer.
