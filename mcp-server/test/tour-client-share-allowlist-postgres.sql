...
begin
  ...
  foreach v_needle in array array[
    ...
    'Eastgate 1200 SF','$24.00/sq.ft/yr NNN','$1.25/sq.ft/mo','Dr.Smith/Jones',
    'Building code 2021','Built to 2018 code','Area code 251','Zip code 36602-1234',
    'Zip code 36602 (Mobile)','Entry via Gate 2','Access from Hwy 98','Key tenants: 3 physicians',
