...
begin
  ...
  if ops.tour_client_field_allowed('access') or ops.tour_client_field_allowed('caveat') or ops.tour_client_field_allowed(null)
     or ops.tour_client_field_allowed('brand_new_field') then
