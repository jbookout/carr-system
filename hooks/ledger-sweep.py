...
# THE TURN-ORIGIN DETECTOR NOW LIVES IN hooks/turn_origin.py, lifted from here
# verbatim on 2026-08-23 with its counted-transcript evidence intact. It moved
# because weekend-quiet-gate.py asked the same question with a guessed allowlist
# and was wrong for a week, while the right answer sat in this file unread.
# Behaviour is unchanged: the lifted copy was compared against this one over
# 3,990 real user records with zero disagreements before the original was
# deleted. Change it there, against a transcript, and both gates move together.
from turn_origin import (  # noqa: E402
    NON_HUMAN_ORIGIN_KINDS,
    NON_HUMAN_TEXT_PREFIXES,
    PEER_RELAY_TAG,
    PEER_RELAY_SCAN_CHARS,
    is_harness_injected,
)
