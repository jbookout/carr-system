...
function renderTour(data) {
  ...
  if (tour.stage === "complete") controls = `<div class="notice"><strong>Tour review complete</strong><p>Original note/photo evidence remains preserved. No business record changed outside this browser.</p></div>`;
